...
Router.prototype.resource = function(route, resource) {
  ...
  this.get(route, '/projects', function(req, res) {resource.list(req, res, db)});
  this.post(route, '/projects', function(req, res) {resource.create(req, res, db)});
  this.get(route + '/projets/:id', function(req, res) {resource.read(req, res, db)});
  this.post(route + '/projects/:id', function(req, res) {resource.update(req, res, db)});
  this.get(route + '/projects/:id/destroy', function(req, res) {resource.destroy(req, res, db)});
}
